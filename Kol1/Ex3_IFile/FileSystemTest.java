...
//            return;
//        }
//        Optional<IFile> opt = files.stream()
//                .filter(f->f.getFileName().equals(file.getFileName())).findAny();
//        if (opt.isPresent())
//        {
//            throw new FileNameExistsException("There is already a file named "
//                    + file.getFileName() + " in the folder "+getFileName());
//        }
//        files.add(file);
//
//    }
